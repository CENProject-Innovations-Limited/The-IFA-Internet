    ...
    <section id="networking" className="section">
      <div className="container">
        ...
        <div className="ifa-networks">
          ...
          {/* 2Geda featured spotlight */}
          <div className="twogeda-spotlight">
            <p className="twogeda-spotlight__label">Social Networks</p>
            <a
              href="https://2geda.net/"
              className="twogeda-card"
              target="_blank"
              rel="noopener noreferrer"
            >
              <div className="twogeda-card__body">
                <span className="twogeda-card__name">2Geda</span>
                <p className="twogeda-card__tagline">Nigeria's first indigenous social media network</p>
                <span className="twogeda-card__url">2geda.net ↗</span>
              </div>
              <span className="twogeda-card__arrow" aria-hidden="true">↗</span>
            </a>
          </div>
        </div>
      </div>
