...
const CALENDARS = [
  {
    ...
    facts: [
      ...
      'Coexists with 7-day Gregorian (adopted 1842)',
    ],
    ...
    <section className="intro-banner">
      <div className="container">
        <div className="intro-banner__inner">
          ...
          <div className="intro-banner__attr">— Yoruba Wisdom Tradition</div>
        </div>
      </div>
    </section>
  );
